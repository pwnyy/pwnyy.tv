          ...
          (t.extract = b),
            ...
            (t.stringifyUrl = function (e, r) {
              ...
              return (
                e.fragmentIdentifier &&
                  (l = "#".concat(
                    r[d] ? m(e.fragmentIdentifier, r) : e.fragmentIdentifier
                  )),
            ...
            (t.pick = function (e, r, o) {
              ...
              return t.stringifyUrl(
                { url: i, query: f(s, r), fragmentIdentifier: u },
                o
              );
            }),
            ...
            function r(t) {
              var r = this.constructor,
                n =
                  e.call(
                    this,
                    "Could not find the provided element: ".concat(t)
                  ) || this;
              return (
                Object.setPrototypeOf(n, r.prototype),
                (n.name = "MissingElementError"),
                n
              );
            }
            return t(r, e), r;
          ...
          A = (function (e) {
            function r(t, r) {
              ...
              return (
                ...
                (n.disableCaptions = n
                  .getPlayer()
                  .disableCaptions.bind(n.getPlayer())),
                (n.enableCaptions = n
                  .getPlayer()
                  .enableCaptions.bind(n.getPlayer())),
                ...
                (n.setChannelId = n
                  .getPlayer()
                  .setChannelId.bind(n.getPlayer())),
                (n.setCollection = n
                  .getPlayer()
                  .setCollection.bind(n.getPlayer())),
                ...
                (n.getChannelId = n
                  .getPlayer()
                  .getChannelId.bind(n.getPlayer())),
                (n.getCollection = n
                  .getPlayer()
                  .getCollection.bind(n.getPlayer())),
                (n.getCurrentTime = n
                  .getPlayer()
                  .getCurrentTime.bind(n.getPlayer())),
                (n.getDuration = n.getPlayer().getDuration.bind(n.getPlayer())),
                (n.getEnded = n.getPlayer().getEnded.bind(n.getPlayer())),
                (n.getPlaybackStats = n
                  .getPlayer()
                  .getPlaybackStats.bind(n.getPlayer())),
                (n.getPlayerState = n
                  .getPlayer()
                  .getPlayerState.bind(n.getPlayer())),
                (n.getQualities = n
                  .getPlayer()
                  .getQualities.bind(n.getPlayer())),
